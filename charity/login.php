...
<?php 
	...
	if(logged_in()) {
		redirect("../CharityDashboard/charitydashboard.php");
	}
  ?>
...
<?php include("includes/nav.php") ?>
 ...
 <option value="#">Register as Charity</option>
 <option value="../volunteer/login.php">Volunteer</option>
  ...
  <div class="container">
		<input id="inputtext" type="text" name="charity_name" id="charity_name" tabindex="1" class="form-control" placeholder="Charity Name" value="" required >
  </div>
  <div class="container">
		<input id="inputtext" type="text" name="charity_registered_id" id="charity_registered_id" tabindex="1" class="form-control" placeholder="Charity Registered Id" value="" required >
	</div>
        <div class="container">
		<input id="inputtext" type="text" name="address" id="address" tabindex="1" class="form-control" placeholder="Address" value="" required >
	</div>
		<div class="container">
		<input id="inputtext" type="text" name="phone_no" id="phone_no" tabindex="1" class="form-control" placeholder="Phone No" value="" required >
	</div>
		<div class="container">
		<input id="inputtext" type="text" name="landline_no" id="landline_no" tabindex="1" class="form-control" placeholder="Landline No" value="" required >
	</div>
		<div class="container">
  ...
  <div id="optionbox" align="center">
	<select name="forma" onchange="location = this.options[this.selectedIndex].value;">
 <option value="#">Login as Charity</option>
 <option value="../volunteer/login.php">Volunteer</option>
</select>
</div>
  ...
  <div id="main" class="slideshow">
	<div id="sync10" class="owl-carousel owl-theme">
	     	...
	     	<div class="item" style="background-image: url(../images/charity6.jpg); width: 100%;">
	       		<div class="container">
	       			<div class="text_zz">
	       				<h3>Please help African<br> children make them<br> a better life.</h3>
	       				<div class="donate">
