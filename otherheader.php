<?php include("login/functions/init.php")  ?>
				...
				<div class="row">
						...
						<div class="col-md-11">
							<div class="row">
								...
								<div class="pull_right">
									...
									<li id="menu-item-249" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-249"><a href="http://oswintechnologies.com/support/"><span style="color:orange; margin-right:10px;">Support</span></a></li>

										<li><span><i class="fa fa-google-wallet"></i>Wallet balance ₹ 25000</span></li>
										<li id="menu-item-249" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-249"><a href="../../logout.php"><span style="color:red; margin-right:-36px; margin-left:11px;"><b>Logout</b></span></a></li>            
					...
					<div class="main_menu">
						...
						<ul class="menu">
							...
							<li>
								<a href="../../pages/shop/shop.php">Shop <span id="sub_6" ></span></a>
